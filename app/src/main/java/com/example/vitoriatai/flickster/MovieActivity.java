package com.example.vitoriatai.flickster;
...
import com.example.vitoriatai.flickster.adapters.MoviesAdapter;
        ...
        client.get(MOVIE_URL, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    // leg helps u find your tag and helps on debugging
